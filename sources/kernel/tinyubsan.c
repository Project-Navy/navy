...
/**
 * TinyUBsan by Abb1x (Modified to run on navy)
 * More info at https://github.com/Abb1x/tinyubsan
 * BSD-2 License
 **/
...
{
    print_format(arch_serial_puts, "\033[31mTinyUBsan\033[0m: {} at file {}, line {}, column {}\n",
